  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        ...
        />
        <motion.div
          className="absolute bottom-24 right-20 w-48 h-48 bg-blue-400/20 rounded-full blur-2xl"
          animate={{ x: [0, -80, 0], y: [0, 50, 0], scale: [1, 0.85, 1] }}
          transition={{ duration: 22, repeat: Infinity, ease: 'easeInOut' }}
        />
      </div>
      ...
      <div className="relative z-10 min-h-screen px-4 py-8 lg:py-12">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-600 rounded-3xl mb-5 shadow-lg">
              <MessageSquare className="w-10 h-10 text-white" />
            </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05, y: -1 }}
                  whileTap={{ scale: 0.95 }}
                  className="p-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg transition-colors"
                >
                  <Send className="w-5 h-5" />
                </motion.button>
              </div>
