...
//   // 🎯 ฟังก์ชัน Reminder แจ้งเตือนนัด
//   useEffect(() => {
...
//         const diff = (appointmentDate.getTime() - now.getTime()) / (1000 * 60) // นาที

//         if (diff > 0 && diff <= 60) { // ถ้านัดภายใน 1 ชั่วโมง
//           setTimeout(() => {
//             alert(`🔔 Reminder: You have an appointment with Dr. ${a.doctor.name} at ${a.time}`)
