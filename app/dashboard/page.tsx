...
//     <div className="flex flex-col md:flex-row min-h-screen bg-blue-50">
//       {/* Sidebar */}
//       <div className="w-full md:w-64 bg-white shadow-lg p-6 flex md:flex-col justify-between md:justify-start items-center md:items-start md:space-y-6 space-x-4 md:space-x-0">
//         <h2 className="text-2xl font-bold text-blue-700 mb-2 md:mb-8">DentalEase</h2>
//         <ul className="flex md:flex-col gap-4 text-sm font-medium">
//           <li>
//             <button onClick={() => router.push('/booking')} className="text-blue-600 hover:underline">
//               ➕ Book Appointment
//             </button>
...
//         {user && (
//           <div className="mb-6">
//             <h1 className="text-3xl font-extrabold text-blue-800">Welcome, {user.name}!</h1>
//             <p className="text-sm text-gray-600">Email: {user.email}</p>
//           </div>
//         )}
...
//                 className="bg-white p-4 rounded-xl shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:shadow-xl transition"
//               >
//                 <div>
//                   <p className="text-sm text-gray-600">📅 {new Date(a.date).toLocaleDateString()} at {a.time}</p>
//                   <p className="font-medium">🧑‍⚕️ {a.doctor.name} ({a.doctor.specialty})</p>
