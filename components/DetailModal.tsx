...
// export default function DetailModal({ isOpen, onClose, appointment }: DetailModalProps) {
//   if (!appointment) return null

//   const { date, time, type, doctor, patientName, symptoms } = appointment
...
//                   <p>🧑‍⚕️ <b>Doctor:</b> {doctor.name} ({doctor.specialty})</p>
//                   <p>📅 <b>Date:</b> {formattedDate} at {time}</p>
//                   <p>📋 <b>Treatment:</b> {type}</p>
//                   {symptoms && <p>💬 <b>Symptoms:</b> {symptoms}</p>}

//                   {type === 'VIDEO_CALL' && (
//                     <p>
//                       🔗 <a href="/telemedicine" className="text-blue-600 underline">Join Video Call</a>
//                     </p>
//                   )}

//                   {type === 'AI_DIAGNOSIS' && (
//                     <p>
//                       🤖 <a href="/ai-analysis" className="text-blue-600 underline">Go to AI Analysis</a>
//                     </p>
//                   )}
//                 </div>
